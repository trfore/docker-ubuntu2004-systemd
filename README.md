...
Inspired by Jeff Geerling's ([@geerlingguy](https://github.com/geerlingguy)), CentOS, Debian, and Ubuntu docker images for ansible, [geerlingguy/docker-\*-ansible](https://github.com/geerlingguy?tab=repositories&q=docker-ansible).
